...
while endless:
	...
	if canIDO(a):
		...
		print("Из статистического определения вероятности математическим ожиданием для дискретной случайной величины будет X среднее, найденное в прошлой строке.")
